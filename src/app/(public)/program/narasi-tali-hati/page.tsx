...
export default async function NarasiTaliHatiPage() {
      ...
      <div className="bg-gradient-to-r from-pink-600 to-purple-700 text-white py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-pink-100 text-lg max-w-2xl">
            Kisah dan refleksi yang menguatkan ikatan batin antara guru, siswa, dan lingkungan sekolah
          </p>
        </div>
      </div>
        ...
        {data?.length ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 max-w-md mx-auto">
              Saat ini belum ada narasi Tali Hati yang tersedia. Silakan cek kembali nanti.
            </p>
          </div>
        )}
      </div>
